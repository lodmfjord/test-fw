/**
 * @fileoverview Tests run-contract-generator-from-settings terraform main generation behavior.
 */
...
describe("runContractGeneratorFromSettings terraform main generation", () => {
